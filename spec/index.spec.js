...
describe('/api', () => {
  ...
  it('GET on /api endpoint RETURNS a JSON with all available endpoints.', () =>
    request
      .get('/api')
      .expect(200)
      .then(({ body }) => {
  ...
  describe('/articles', () => {
    it('Returns an ERROR with a status code of 400 if an unrecognised endpoint is entered after /articles.', () =>
      request
    ...
    describe('/:article_id', () => {
      ...
      it('GET using the article_id endpoint will return a 404 error if the ID passed in the request parameter does not match an article_id that exists.', () =>
        request
          .get('/api/articles/900')
          .expect(404)
          .then(({ body }) => {
      ...
      it('PATCH using the article_id endpoint will deal with a vote request to add votes. It will ignore the request if no value is passed into inc_votes and return a 400 error code.', () =>
        request
